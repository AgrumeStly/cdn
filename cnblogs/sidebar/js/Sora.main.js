(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`Trotyl | ${autherName}`, `${blogTitle}`));
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href="https://www.cnblogs.com/-tnt-/p/about.html "><i class="fa fa-meetup" aria-hidden="true"></i> 关于</a></li>' +
					'</ul>';
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/-tnt-/" alt="Trotyl">' +
					'<ruby><span class="sakuraso">Trotyl</span><span class="no">の</span><span class="shironeko">Blog</span>' +
					'<rt class="chinese-font">Trotyl的博客</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://www.cnblogs.com/-tnt-/"><img src="//pic.cnblogs.com/avatar/1932857/20201024193430.png"></a></span><span><a href="https://www.cnblogs.com/-tnt/">Toretto</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
